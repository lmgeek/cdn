...
export class MusicPlayerService {
  ...
  private sounds : TrackDto[] = [
    ...
    {id: 31, name: 'Nada es Imposible - Planetshakers (C)', fileName: 'Nada Es Imposible (C).mp3', link: 'https://cdn.jsdelivr.net/gh/lmgeek/cdn/audios/Nothing%20Is%20Imposible%20(C).mp3'},
